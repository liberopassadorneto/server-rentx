...
describe("Create Category Controller", function () {
    ...
    it("it should be able to create a new category", function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    it("it should be not able to create a new category if name already exists", function () { return __awaiter(void 0, void 0, void 0, function () {
        var responseToken, refresh_token, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, supertest_1.default)(app_1.app).post("/sessions").send({
