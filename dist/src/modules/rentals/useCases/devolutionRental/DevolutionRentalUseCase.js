...
var DevolutionRentalUseCase = /** @class */ (function () {
    ...
    DevolutionRentalUseCase.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var rental, car, minimumDaily, currentReturnDate, daily, delay, total, calculateFine;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        minimumDaily = 1;
                        if (!rental) {
                            throw new AppError_1.AppError("Rental not found");
                        }
                        currentReturnDate = this.dateProvider.dateNow();
                        daily = this.dateProvider.compareInDays(currentReturnDate, rental.start_date);
                        // Se o carro for devolvido com menos de 24 horas, deverá ser cobrado uma diária completa.
                        if (daily <= 0) {
                            daily = minimumDaily;
                        }
                        delay = this.dateProvider.compareInDays(currentReturnDate, rental.expected_return_date);
                        total = 0;
                        if (delay > 0) {
                            calculateFine = delay * car.fine_amount;
                            total = calculateFine;
                        }
